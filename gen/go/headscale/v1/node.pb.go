...
const file_headscale_v1_node_proto_rawDesc = "" +
	...
	"\x04node\x18\x01 \x01(\v2\x12.headscale.v1.NodeR\x04node\"a\n" +
	"\x1cChangeIPAddressesNodeRequest\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\x04R\x06nodeId\x12(\n" +
	"\x10new_ip_addresses\x18\x02 \x01(\tR\x0enewIpAddresses\"G\n" +
	"\x1dChangeIPAddressesNodeResponse\x12&\n" +
	"\x04node\x18\x01 \x01(\v2\x12.headscale.v1.NodeR\x04node\"&\n" +
...
var file_headscale_v1_node_proto_goTypes = []any{
	...
	(*ChangeIPAddressesNodeRequest)(nil),  // 16: headscale.v1.ChangeIPAddressesNodeRequest
	(*ChangeIPAddressesNodeResponse)(nil), // 17: headscale.v1.ChangeIPAddressesNodeResponse
...
var file_headscale_v1_node_proto_depIdxs = []int32{
	...
	1,  // 13: headscale.v1.ChangeIPAddressesNodeResponse.node:type_name -> headscale.v1.Node
